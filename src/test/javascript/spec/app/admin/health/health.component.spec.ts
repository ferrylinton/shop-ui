...
import { MstHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { MstHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('MstHealthCheckComponent', () => {

        let comp: MstHealthCheckComponent;
        let fixture: ComponentFixture<MstHealthCheckComponent>;
        let service: MstHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [ShopTestModule],
                declarations: [MstHealthCheckComponent],
                providers: [
                    MstHealthService
                ]
            })
            .overrideTemplate(MstHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MstHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(MstHealthService);
        });
