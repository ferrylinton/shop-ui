...
import { MstLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: MstLoginModalComponent;
        let fixture: ComponentFixture<MstLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MstLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(MstLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MstLoginModalComponent);
